...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run Q2-SMALL-EMOTION-07 robustness profile audit.")
    parser.add_argument(
        "--q2-complete-dir",
        type=Path,
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("outputs/factor_discovery/small_emotion/q2_robustness_audit_20260520"),
    )
