...
multifactor-wrds-config-check:
	PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=$(PYTHONPATH_MULTIFACTOR) $(PYTHON) projects/multifactor_alpha_validation/scripts/run_wrds_multifactor_ingest.py --check-config-only
