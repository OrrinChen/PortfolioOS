...
.PHONY: multifactor-portfolio-cost-capacity
.PHONY: multifactor-full-market-sweep
.PHONY: multifactor-full-market-supervisor
.PHONY: multifactor-full-market-candidate-audit
...
multifactor-portfolio-cost-capacity:
	PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=$(PYTHONPATH_MULTIFACTOR) $(PYTHON) projects/multifactor_alpha_validation/scripts/run_portfolio_cost_capacity_attribution.py

multifactor-full-market-sweep:
	PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=$(PYTHONPATH_MULTIFACTOR) $(PYTHON) projects/multifactor_alpha_validation/scripts/run_full_market_multifactor_sweep.py

multifactor-full-market-supervisor:
	PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=$(PYTHONPATH_MULTIFACTOR) $(PYTHON) projects/multifactor_alpha_validation/scripts/run_full_market_multifactor_supervisor.py

multifactor-full-market-candidate-audit:
	PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=$(PYTHONPATH_MULTIFACTOR) $(PYTHON) projects/multifactor_alpha_validation/scripts/run_full_market_candidate_full_audit.py
