...
.PHONY: test lint validate-examples audit-report demo demo-v2 typed-alpha-closeout typed-q2-adapter-fixture typed-expected-return-injection-fixture typed-optimizer-response-acceptance sue-typed-q2-survival no-network validate
